...
# Draft until Wei signs off on the copy + the public URL (patent-pending project).
draft: true
...
*Because Safe Colab is the subject of a patent application, this page describes only
the project's goals; technical details are intentionally omitted.*

---

*Disclosure: Joanna Hård and Simin Zhang are involved in **Amun AI**, a KTH spin-off
that aims to commercialize Safe Colab.*

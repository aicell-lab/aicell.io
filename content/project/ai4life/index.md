...
slides: model-zoo
---
> **Status: completed.** AI4Life ran from 2022 to 2025 as a Horizon Europe project. The infrastructure and community services the AICell Lab built within it continue today through the [BioImage Model Zoo](/project/bioimage-model-zoo) and [BioEngine](/project/bioengine).
...
Now that the project has concluded, the consortium has published a retrospective on its three Open Calls and Public Challenges (2023–2025) — [*AI4Life Open Calls and Public Challenges: why, how, and what we have learned*](https://doi.org/10.64898/2026.07.21.739486) — reflecting on 22 supported bioimage-analysis projects and the finding that, for scientific AI in biology, the rate-limiting step is not models but the data, annotations, and shared infrastructure underneath them.

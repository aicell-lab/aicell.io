...
REEF runs the same loop around the clock. This is one turn of it, rendered from the lab's digital
...
<iframe src="https://drive.google.com/file/d/1m5QK8-CXJyyn_VATnxiEgvllb2wPWt3_/preview" width="100%" height="460" allow="autoplay" allowfullscreen frameborder="0" style="border-radius:8px;"></iframe>
...
The pipetting is drawn simplified, for legibility rather than as a simulation.

### The farm in action

And here is the same workflow on the real hardware. The robotic arm moving a plate between the
incubator and the microscope, part of a fully automated imaging run:
